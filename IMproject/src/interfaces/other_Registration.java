 ...
 * @author User
 */
public class other_Registration extends javax.swing.JPanel {
    ...
    {
       try {
            ResultSet r = db.getData("SELECT MAX(E_id)from employee  where E_id like '700010%' ");
            while (r.next()) {
            ...
            Logger.getLogger(other_Registration.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
   ...
   private  void deleteVal()
   {
	...
	((DefaultTableModel)EdataTable.getModel()).removeRow(0);
        ...
        try {
            DefaultTableModel dtm = (DefaultTableModel) EdataTable.getModel();
            ResultSet r = db.getData("Select * from employee where joined_date >= '" + Jdate1 + "' and joined_date <= '" + Jdate2+ "' and E_id like '700010%'");
	...
	((DefaultTableModel)EdataTable.getModel()).removeRow(0);
        ...
        try {
            DefaultTableModel dtm = (DefaultTableModel) EdataTable.getModel();
            ResultSet r = db.getData("select employee.E_id,employee.Efname,employee.Elname,employee.age,employee.gender,employee.DOB,employee.NIC,employee.Email,employee.address,employee.joined_date,employee.discription,designation.desig from employee join designation on employee.E_id = designation.E_id  where employee.E_id like '"+txtsearchbyname.getText()+"%' and employee.E_id like '700010%' or employee.Efname like '"+txtsearchbyname.getText()+"%' and employee.E_id like '700010%' or employee.Elname like '"+txtsearchbyname.getText()+"%' and employee.E_id like '700010%' or employee.NIC like '"+txtsearchbyname.getText()+"%' and employee.E_id like '700010%' or designation.desig like '"+txtsearchbyname.getText()+"%' and employee.E_id like '700010%' ");
...
//db.putData("insert into employee(E_id,Efname,Elname,age,gender,DOB,NIC,Email,address,joined_date,discription)values('"+txtID.getText()+"','"+txtfname.getText()+"','"+txtlname.getText()+"','"+txtage.getText()+"','"+date_join.getText()+"','"+dateOB.getText()+"','"+txtNIC.getText()+"','"+txtEmail.getText()+"','"+txtaddress.getText()+"','"+date_join.getText()+"','"+txtDiscription.getText()+"')");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Other employee Regitration");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 0, -1, -1));
        ...
        txt_combo_designation.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Other employee" }));
